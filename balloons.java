...
public class balloons
{
    ...
    {
        Scanner in = new Scanner(new File("balloons.in"));
        int teams = 9;
       ...
       while(teams != 0)
       {
           ...
           //System.out.println("teams: " + teams + " balloonsA: " + balloonsA + " balloonsB: " + balloonsB);
           ...
           for(int k = 0; k < teams; k++)
           {
               ...
               {
                   if(distAs[k] > distBs[k] && balloonsB > 0)
                   {
                       distTotal+=distBs[k];
                       balloonsB--;
                   }
                   else if(distBs[k] > distAs[k] && balloonsA > 0)
                   {
                       distTotal+=distAs[k];
                       balloonsA--;
                   }
